    ...
    try:
        ...
        try:
            ...
            return {
                ...
                "message": "The application is running in minimal mode due to CUDA dependency issues. Only basic text extraction is available."
            }
            ...
            return {
                "status": "error",
                "mode": "minimal",
                "message": "Could not perform even minimal text extraction due to dependency issues."
            }
